...
import argparse
from socket import *
from Python_3.0.utils import receive_size
from Python_3.0.utils import presence_d

def create_parser():
    parser = argparse.ArgumentParser()
    parser.ass_argument("address", help='server\'s ip', type=str)
    parser.add_argument('port', default=7777, help='server\'s port')
    return parser
